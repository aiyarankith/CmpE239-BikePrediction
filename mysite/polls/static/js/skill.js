...
function i(a) {
    ...
    d
        ...
        .style("fill", function (a) { return getcolor(d3.rgb(a._color)) < 150 ? "#ffffff" : "#E5E5E5" })
...
function k(a) {
    var c = ["#4CC3D9", "#FFC65D", "#7BC8A4", "#93648D", "#ffa500"],
        d = [-.1, -.05, 0];
    if (1 == a.depth) {
...
sunburst.append("svg:circle").attr("r", rad).style("opacity", 0.2);
var t = function (a, b) {
        var c = [],
            d = a.length;
